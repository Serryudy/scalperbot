...
class BinanceFuturesBot:
    ...
    def execute_trade(self, signal):
        ...
        # Handle buy signal - ONLY PLACE ORDERS FOR BUY SIGNALS
        ...
        # Sell signals are ignored - no orders placed
        elif signal == 1:  # Sell signal
            logger.info("SELL signal detected but ignoring - only trading BUY signals")
            # Do not place any orders for sell signals
